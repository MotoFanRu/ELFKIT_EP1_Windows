...
typedef enum _AHIPOWERFTR_T {
	AHIPWRFTRDISPLAY = 0, // Display only
	AHIPWRFTRDRAW,        // Entire graphics draw block
	AHIPWRFTRUSB,
	AHIPWRFTRSD,
	AHIPWRFTRTS,
	AHIPWRFTRVIDCAP,
	AHIPWRFTRSYSTEM,      // Setting mode of the entire chip, regardless of feature
	AHIPWRFTRNUM,
	AHIPWRFTRMAX = 0x7FFFFFFF
} AHIPOWERFTR_T;

typedef enum _AHIPOWERMODE_T {
	AHIPWRMODESUSPEND = 0,
	AHIPWRMODERESUME,
	AHIPWRMODESTANDBY,
	AHIPWRMODEOFF,
	AHIPWRMODEINIT,
	AHIPWRMODEMAXPWRSAVE,
	AHIPWRMODESLOW,
	AHIPWRMODENORMAL,
	AHIPWRMODEFAST,
	AHIPWRMODETURBO,
	AHIPWRMODEAUTO,
	AHIPWRMODENUM,
	AHIPWRMODEMAX = 0x7FFFFFFF
} AHIPOWERMODE_T;

UINT32 AhiPwrModeGet(AHIDEVCONTEXT_T context, AHIPOWERFTR_T pwrFtr, AHIPOWERMODE_T *pwrMode, UINT32 flags);

UINT32 AhiPwrModeSet(AHIDEVCONTEXT_T context, AHIPOWERFTR_T pwrFtr, AHIPOWERMODE_T pwrMode, UINT32 flags);
